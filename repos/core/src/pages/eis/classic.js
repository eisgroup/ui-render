...
const DATA_URL = 'http://localhost:8080/ipb-app/services/rating-rs/v1/gb-std/report/'
const META_URL = 'http://localhost:8080/ipb-app/services/rating-rs/v1/gb-std/report/metadata'
...
export default class ClassicPage extends Component {
  ...
  render () {
    ...
    return (this.hasData && this.hasMeta
        ? <Classic data={data} meta={meta} initialValues={data}/>
        : <Placeholder>
          {!this.hasData &&
