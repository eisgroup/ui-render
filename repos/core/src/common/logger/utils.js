...
import { DISCONNECTED, ERROR, GET, ONE_SECOND, REPORT, SET, TIMEOUT } from '../constants'
import { first, last, performStorage, toList, toListValuesTotal, warn } from '../utils'
import { ACTIVE } from '../variables'
import {
  MAX_ERROR_RECORDS,
  MAX_IDLE_DURATION,
  MAX_LATENCY_RECORDS,
