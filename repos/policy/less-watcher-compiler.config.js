  ...
  return {
    ...
    files: [ // list of source files to watch for changes and corresponding tasks to run
      ...
      },
      {
        ...
        watch: [
          '../web/style/fonts/**/*.{eot,eof,svg,ttf,woff,woff2}', // watch for changes of all file types within `style/fonts/` directory
        ],
        compile: '../web/style/fonts/**/*.{eot,eof,svg,ttf,woff,woff2}', // only copy over files with matched extensions
