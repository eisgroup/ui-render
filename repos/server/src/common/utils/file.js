import { warn } from 'core/src/common/utils'
import { _WORK_DIR_, UPLOAD_PATH } from 'core/src/common/variables'
import fs from 'fs'
...
export async function saveFile ({stream, filename, folders = '', dir = null, resize = null}) {
  if (!dir) dir = UPLOAD_PATH + folders
...
export function removeFile ({filename, folders = '', dir = null, path = null}) {
  if (!path) path = (dir || (UPLOAD_PATH + folders)) + '/' + filename
