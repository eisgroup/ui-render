...
import { ConfigContext, PopupContext } from '../../contexts'
        ...
        return (
            <ConfigContext.Provider value={{ dateFormat }}>
                <PopupContext.Provider
                    value={{ isOpen: isPopupOpen, togglePopupState, title: popupTitle, content: popupContent }}>
                    <Container {...props}>
                        {childBefore}
...
const UIRenderWithUISetup = withUISetup({
    subscription: {
        pristine: true,
        valid: true,
        values: true,
