...
import { hasListValue, isEmpty, isEqual, ONE_DAY, removeNilValues } from 'ui-utils-pack'
import { fromTimeRanges, toTimeRange } from 'ui-utils-pack/time'
...
import { date, hourMinute } from './normalizers'
...
export default class Dates extends PureComponent {
  ...
  get inputProps () {
    const {
      info, float, required, disabled, readonly,
